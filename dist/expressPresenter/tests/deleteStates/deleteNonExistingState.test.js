...
describe('expressPresenter.deleteStates with non-existing state', function () {
    ...
    it('should not error when deleting', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, deleteStates_1.default().expect(httpCodes_1.NO_CONTENT_204_HTTP_CODE)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('should throw warnings when missing the activity id', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, deleteStates_1.default({ activityId: undefined }).expect(httpCodes_1.CLIENT_ERROR_400_HTTP_CODE)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('should throw warnings when missing the agent', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, deleteStates_1.default({ agent: undefined }).expect(httpCodes_1.CLIENT_ERROR_400_HTTP_CODE)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
