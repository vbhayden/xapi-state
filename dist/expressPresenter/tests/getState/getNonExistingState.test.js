...
describe('expressPresenter.getState with non-existing model', function () {
    ...
    it('should error when getting a non-existing model', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getState_1.default().expect(http_status_codes_1.NOT_FOUND)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('should throw warnings when missing the activity id', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getState_1.default({ activityId: undefined }).expect(http_status_codes_1.BAD_REQUEST)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('should throw warnings when missing the agent', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getState_1.default({ agent: undefined }).expect(http_status_codes_1.BAD_REQUEST)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
