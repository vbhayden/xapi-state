    ...
    it('should get when getting text', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, getState_1.default().expect(httpCodes_1.OK_200_HTTP_CODE, testValues_1.TEST_CONTENT)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('should get when not using registration', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, getState_1.default({ registration: undefined }).expect(httpCodes_1.OK_200_HTTP_CODE, testValues_1.TEST_CONTENT)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('should get when getting json', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, getState_1.default().expect(httpCodes_1.OK_200_HTTP_CODE, JSON.parse(testValues_1.TEST_JSON_CONTENT))];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('should error when getting existing model without a registration with one', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, getState_1.default().expect(httpCodes_1.NOT_FOUND_404_HTTP_CODE)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
