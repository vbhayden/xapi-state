...
var createJsonState_1 = require("../../../utils/createJsonState");
...
describe('expressPresenter.getState with existing state', function () {
    ...
    it('should 400 without version header', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, getState_1.default({}, false).expect(http_status_codes_1.BAD_REQUEST)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('should get when getting text', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, getState_1.default().expect(http_status_codes_1.OK, testValues_1.TEST_CONTENT)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    // tslint:enable:object-literal-sort-keys
                    _a.sent();
                    return [4 /*yield*/, getState_1.default({ agent: retrievalAgent }).expect(http_status_codes_1.OK, testValues_1.TEST_CONTENT)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('should get when not using registration', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, createTextState_1.default()];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, getState_1.default({ registration: undefined }).expect(http_status_codes_1.OK, testValues_1.TEST_CONTENT)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('should get when getting json', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, getState_1.default().expect(http_status_codes_1.OK, JSON.parse(testValues_1.TEST_JSON_CONTENT))];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('should error when getting existing model without a registration with one', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, createTextState_1.default({ registration: undefined })];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, getState_1.default().expect(http_status_codes_1.NOT_FOUND)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('should get when not using mbox', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, getState_1.default({ agent: JSON.stringify(testValues_1.TEST_MBOX_AGENT) })
                            .expect(http_status_codes_1.OK, testValues_1.TEST_CONTENT)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('should get when not using mbox_sha1sum', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, getState_1.default({ agent: JSON.stringify(testValues_1.TEST_MBOXSHA1_AGENT) })
                            .expect(http_status_codes_1.OK, testValues_1.TEST_CONTENT)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
    ...
    it('should get when not using openid', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, getState_1.default({ agent: JSON.stringify(testValues_1.TEST_OPENID_AGENT) })
                            .expect(http_status_codes_1.OK, testValues_1.TEST_CONTENT)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
    ...
    it('should get when not using account', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, getState_1.default({ agent: JSON.stringify(testValues_1.TEST_ACCOUNT_AGENT) })
                            .expect(http_status_codes_1.OK, testValues_1.TEST_CONTENT)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
