...
var deleteState_1 = require("./utils/deleteState");
    ...
    it('should delete when deleting text', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, deleteState_1.default().expect(httpCodes_1.NO_CONTENT_204_HTTP_CODE)];
                case 2:
                    _a.sent();
    ...
    it('should error when deleting existing model without a registration with one', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, deleteState_1.default().expect(httpCodes_1.NOT_FOUND_404_HTTP_CODE)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('should delete when deleting with an mbox', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, deleteState_1.default({ agent: JSON.stringify(testValues_1.TEST_MBOX_AGENT) })
                            .expect(httpCodes_1.NO_CONTENT_204_HTTP_CODE)];
                case 2:
                    _a.sent();
    ...
    it('should delete when deleting with an mbox_sha1sum', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, deleteState_1.default({ agent: JSON.stringify(testValues_1.TEST_MBOXSHA1_AGENT) })
                            .expect(httpCodes_1.NO_CONTENT_204_HTTP_CODE)];
                case 2:
                    _a.sent();
    ...
    it('should delete when deleting with an openid', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, deleteState_1.default({ agent: JSON.stringify(testValues_1.TEST_OPENID_AGENT) })
                            .expect(httpCodes_1.NO_CONTENT_204_HTTP_CODE)];
                case 2:
                    _a.sent();
    ...
    it('should delete when deleting with an account', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, deleteState_1.default({ agent: JSON.stringify(testValues_1.TEST_ACCOUNT_AGENT) })
                            .expect(httpCodes_1.NO_CONTENT_204_HTTP_CODE)];
                case 2:
                    _a.sent();
