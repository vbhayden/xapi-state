...
describe('expressPresenter.deleteState with existing state', function () {
    ...
    it('should delete when deleting text', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, deleteState_1.default().expect(http_status_codes_1.NO_CONTENT)];
                case 2:
                    _a.sent();
    ...
    it('should not delete when deleting existing model without a registration with one', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
