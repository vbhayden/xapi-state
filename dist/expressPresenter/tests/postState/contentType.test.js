...
describe(__filename, function () {
    ...
    it('should not error when using a charset for JSON ', function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    it('should not error when using a charset for alternate requests ', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, supertest
                        .post(constants_1.route)
