...
var deleteWithService_1 = require("./deleteWithService");
var getWithService_1 = require("./getWithService");
var overwriteStateWithService_1 = require("./overwriteStateWithService");
var patchStateWithService_1 = require("./patchStateWithService");
var getQuery = function (stream) { return __awaiter(_this, void 0, void 0, function () {
    var body, decodedBody;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, streamToString(stream)];
            case 1:
                body = _a.sent();
...
var getHeaders = function (bodyParams, req) {
    ...
    return __assign({}, reqHeaders, lowerCaseBodyParams);
};
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    ...
                    content = stringToStream(lodash_1.get(query, 'content', ''));
