...
exports.default = function (config, req) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                client = _a.sent();
                contentType = getContentType_1.default(req.header('Content-Type'));
                ...
                content = getContent(req, contentType);
                return [2 /*return*/, {
...
//# sourceMappingURL=getStateWriteOpts.js.map