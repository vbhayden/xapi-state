...
var getStateFromService_1 = require("./utils/getStateFromService");
var getStatesFromService_1 = require("./utils/getStatesFromService");
...
exports.default = function (config) {
    return catchErrors_1.default(config, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        var client, agent, activityId, registration, since, stateId;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (!(req.query.stateId === undefined)) return [3 /*break*/, 3];
                    return [4 /*yield*/, getStatesFromService_1.default({ config: config, res: res, activityId: activityId, agent: agent, client: client, registration: registration, since: since })];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
                case 3:
                    stateId = req.query.stateId;
                    return [4 /*yield*/, getStateFromService_1.default({ config: config, res: res, activityId: activityId, agent: agent, client: client, registration: registration, stateId: stateId })];
                case 4:
                    _a.sent();
                    return [2 /*return*/];
            }
